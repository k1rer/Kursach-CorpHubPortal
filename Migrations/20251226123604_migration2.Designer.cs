...
namespace Kursach_CorpHubPortal.Migrations
{
    ...
    [Migration("20251226123604_migration2")]
                    ...
                    b.ToTable("Departments", "dbo", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Department_Name_HasLetters", "[Name] LIKE '%[A-Za-zА-Яа-я]%'");
                    ...
                    b.ToTable("Positions", "dbo", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Position_Title_HasLetters", "[Title] LIKE '%[A-Za-zА-Яа-я]%'");
